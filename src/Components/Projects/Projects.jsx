  ...
  return (
    <>
        ...
        <div className="mt-5 pt-5">
          <div className="d-flex justify-content-between">
            ...
            <p className="text-info ">
              <span className="pe-1">learn more</span>{" "}
        ...
        <div className="container">
          <div className="row justify-content-center  align-content-center align-items-center">
            <div className="d-flex align-self-center w-25 align-items-center mt-5">
              ...
              <div className="customsqr d-flex justify-content-center align-items-center">
      ...
      <div className="text-center">
        <h2 className="text-center m-2 mb-4 fs-2 fw-bolder">
          OUR TOP CUSTOMERS
        </h2>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam dolorum
          pariatur quidem! Assumenda, voluptas sed.
        </p>
      </div>
      <div>
