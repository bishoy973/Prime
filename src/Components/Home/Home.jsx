    ...
    <>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-3 text-white">
              ...
              <p>
                In 2020 Prime made an agreement with Atta sons to integrate the contracting works and maintenance works
                with one of the biggest workshops in the middle east
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container">
        <div className="d-flex justify-content-between">
          ...
          <p className="customProjects text-info fw-bolder" onClick={() => nav("/workshop")}>
            <span className="pe-1">Show more</span> <i class="fa-solid fa-arrow-right"></i>
          </p>
        </div>
      ...
      <div className="text-center mt-5 pt-5 my-5">
        ...
        <p className="container px-5 justify-content-center text-center">
          One of the largest integrated service centers in heavy-duty maintenance with the provision of all services in
          the areas that characterize our company e.g. Metalworking and forming field, Metal Cutting, Dynamic Balancing
          Field, welding field.
        </p>
